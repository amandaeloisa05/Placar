...
class PaginaJogos:
    def __init__(self, root, on_jogo_selecionado, toggle_mode):
        ...
        self.btn_toggle_mode = ctk.CTkButton(self.frame, text="Modo Escuro", command=self.toggle_mode)
        self.btn_toggle_mode.pack(pady=10)

    def atualizar_texto_botao(self, modo):
        texto_botao = "Modo Claro" if modo == "dark" else "Modo Escuro"
        self.btn_toggle_mode.configure(text=texto_botao)
